      ...
      <div id="app">
        ...
        <section class="content">
          <div class="admin-container">
            ...
            <div class="violation-user">送信内容確認</div>
            <form method="post" action="confirm/send">
              @csrf
              <div class="contact-form-container">
                <div class="form-top-space"></div>
                <div class="contact-form-wrapper">
                  <div class="admin-form-area">
                    <h4 class="admin-form-title">タイトル</h4>
                    <h4 class="admin-form-title1">{{ $inputs['title'] }}</h4>
                    <input type="hidden" name="title" value="{{ $inputs['title'] }}" class="contact-form-content">
                  </div>
                  <div class="admin-content-area">
                    <h4 class="admin-content">通知内容</h4>
                    <h4 class="admin-content1">{!! nl2br(e($inputs['body'])) !!}</h4>
                    <input type="hidden" name="body" value="{{ $inputs['body'] }}">
                  </div>
                  <button type="submit" name="action" value="submit" class="contact-form-btn">送信</button>
