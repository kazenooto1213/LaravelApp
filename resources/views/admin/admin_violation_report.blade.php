      ...
      <div id="app" class=" ">
        ...
        <section class="content">
          <div class="admin-container">
            ...
            <div class="violation-user">違反投稿者処置</div>
            <div class="offender-delete-area">
              該当ユーザー名
            </div>
            <div class="offender-user-area">{{ $user->name }}</div>
            <div class="offender-delete-area1">
              違反投稿内容&nbsp;&nbsp;最終確認
            </div>
            <div class="final-confirmation">{{ $advice->advice }}</div>
            <form method="post" action="admin/violation/report/delete">
              @csrf
              @method('DELETE')
              <div class="advice-menu-container">
                <button type="button" class="offender-delete-btn" data-toggle="modal" data-target="#violationPostModal">違反者削除</button>
              </div>
                <!-- モーダル・ダイヤログ -->
                <div class="modal" id="violationPostModal" tabindex="-1" aria-hidden="true">
                  <div class="modal-dialog modal-lg user-modal">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title">違反投稿者削除の確認</h4>
                      </div>
                      <div class="modal-body">
                        <p class="danger-title">違反投稿者を削除しますか？</p>
                      </div>
                      <div class="modal-footer">
                        <input type="hidden" name="id" value="{{ $user->id }}">
                        <button id="offender-delete-btn1" type="submit">削除</button>
                        <button type="button" class="cancel-btn" data-dismiss="modal">キャンセル</button>
                      </div>
                    </div>
                  </div>
                </div>
